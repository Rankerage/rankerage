...
(function() {
  ...
  I18N.init().then(function() {
    ...
    document.getElementById('detailBody').innerHTML='<div class="detail-country">'+(I18N.countryName(code)||data.country_name_en)+'</div><div class="detail-native">'+(data.country_name_local||'')+'</div>'+
      '<div class="detail-comments" style="margin:8px 0;padding:8px 0;border-top:1px solid var(--border);border-bottom:1px solid var(--border);">'+
        '<div class="comments-title" style="margin-bottom:6px;">💬 Comments</div>'+
        '<div class="comments-list" id="commentsList" style="max-height:100px;overflow-y:auto;margin-bottom:6px;"></div>'+
        '<div class="comment-form" style="display:flex;gap:4px;align-items:center;">'+
          '<input type="text" class="comment-nick" id="commentNick" placeholder="Nickname" maxlength="20" style="width:70px;height:26px;background:var(--bg-input);border:1px solid var(--border);border-radius:4px;color:var(--text-primary);font-size:11px;padding:0 4px;font-family:inherit;flex-shrink:0;">'+
          '<input type="text" class="comment-input" id="commentInput" placeholder="Write..." style="flex:1;height:26px;background:var(--bg-input);border:1px solid var(--border);border-radius:4px;color:var(--text-primary);font-size:11px;padding:0 6px;font-family:inherit;">'+
          '<button class="comment-submit" id="commentSubmit" style="height:26px;padding:0 10px;background:var(--accent);border:none;border-radius:4px;color:#fff;font-size:11px;font-weight:600;cursor:pointer;flex-shrink:0;">Post</button>'+
        '</div>'+
      '</div>'+
